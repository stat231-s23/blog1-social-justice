...
ggplot(policy_words, aes(x=seq, y=value)) +
  ...
  labs(x="Word Sequence", y="AFINN Sentiment", title = "Sentiment in Opinion Articles About Amherst Policies")
...
kable(opinions_pos, col.names = c("Word", "Frequency"), caption = "Top 15 Words in the Student Opinion articles classified as 'positive' in NRC lexicon by frequency") %>%
  kable_styling(font_size = 8) %>%
  row_spec(0,bold=TRUE) 
```
